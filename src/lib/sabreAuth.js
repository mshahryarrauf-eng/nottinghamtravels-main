...
console.log("=== SABRE FULL REQUEST ===");
console.log("URL:", `${process.env.SABRE_BASE_URL}/v2/auth/token`);
console.log("Authorization Header: Basic", basicAuth);
console.log("Body:", body);
console.log("encodedId (step1):", encodedId);
console.log("encodedSecret (step1):", encodedSecret);
console.log("Final basicAuth (step2):", basicAuth);
console.log("=========================");
  try {
