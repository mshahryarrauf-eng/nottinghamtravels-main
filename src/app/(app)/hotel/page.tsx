...
export const metadata = buildMetadata({
  ...
  description:
    "Find and book hotels worldwide at the best prices. From budget stays to 5-star luxury resorts — search thousands of properties with instant confirmation.",
  keywords: [
    "book hotels online", "cheap hotels UK", "hotel deals",
    "luxury hotels", "budget hotels", "hotel search",
    "hotels worldwide", "best hotel prices",
  ],
  path: "/hotel",
});
