...
export const metadata = buildMetadata({
  title: "Contact Us",
  description:
    "Get in touch with Nottingham Travels. Our expert travel consultants are available to help you plan your perfect holiday, answer queries, and provide quotes.",
  keywords: [
