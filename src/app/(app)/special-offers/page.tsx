...
export const metadata = buildMetadata({
  ...
  description:
    "Discover exclusive travel offers and holiday deals from Nottingham Travels. Save on flights, hotels, and vacation packages — limited-time prices.",
  keywords: [
    "special travel offers", "holiday deals UK", "exclusive travel deals",
    "cheap holiday packages", "discounted flights", "last minute offers",
  ],
  path: "/special-offers",
});
