...
export const metadata = buildMetadata({
  title: "Flights, Hotels & Holiday Packages",
  description:
    "Nottingham Travels — ATOL & ABTA protected UK travel agency. Search and book cheap flights, hotels, and holiday packages including Hajj & Umrah tours.",
  keywords: [
    "cheap flights", "hotel deals", "holiday packages UK",
    "ATOL protected holidays", "Hajj packages", "Umrah packages",
    "travel deals Nottingham", "flight booking",
  ],
  path: "/",
});
