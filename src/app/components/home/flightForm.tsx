...
// import { motion } from "framer-motion"
// import { Search } from "lucide-react"
// import AirportAutocomplete from "./airportAutocomplete"   // ← new
// import DateField from "./dateField"
// import PassengerField from "./passengerField"
...
//   function validate(): string | null {
//     if (!from.trim()) return "Please enter a departure airport."
//     if (!to.trim()) return "Please enter a destination airport."
//     if (!departureDate) return "Please select a departure date."
//     if (tripType === "return" && !returnDate) return "Please select a return date."
//     if (!email.trim()) return "Please enter your email address."
//     if (!/\S+@\S+\.\S+/.test(email)) return "Please enter a valid email."
...
//         cabinClass: cabinClass.toUpperCase().replace(/ /g, "_"),
//         preferredAirline:
//           preferredAirline === "Any Airline" ? null : preferredAirline,
//         email,
//         phone,
//       }
...
//           </select>
//           <svg
//             className="absolute right-2 bottom-2.5 h-4 w-4 text-gray-400 pointer-events-none"
//             fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}
//           >
//             <path strokeLinecap="round" strokeLinejoin="round" d="M19 9l-7 7-7-7" />
//           </svg>
...
import { Search } from "lucide-react"
import AirportAutocomplete from "./airportAutocomplete"   // ← new
import AirlineAutocomplete from "./airlineAutocomplete"   // ← new
import DateField from "./dateField"
import PassengerField from "./passengerField"
  ...
  async function handleSearch() {
    ...
    try {
      const body = {
        ...
        cabinClass: cabinClass.toUpperCase().replace(/ /g, "_"),
        preferredAirline: preferredAirline.trim() || null,
        email,
        phone,
      }
